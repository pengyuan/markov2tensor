...
import numpy
import pylab
from tensor_factorization.hosvd import frobenius_norm, reconstruct, HOSVD
from tensor_factorization.mobility import init_data, preprocess, trans
from tensor_factorization.util import get_length_height
...
if __name__ == '__main__':
    ...
    temp_data, time_slice, train = init_data(time_slice, train, region, filter_count)
    ...
    tensor = trans(train_structure_data, order, len(axis_pois), len(axis_users), time_slice)
