...
def find_lcs(s1, s2):
    ...
    s = []
    while 1:
        if abs(p1) > numpy.array(d).shape[0] or abs(p2) > numpy.array(d).shape[1]:
            break
        c = d[p1][p2]
...
if __name__ == '__main__':
    ...
    print find_lcs(['a','b','c','o','i','s','j','f'], ['a','x','b','a','o','e','i','j','f'])
    print find_lcs_len(['a','b','c','o','i','s','j','f'], ['a','x','b','a','o','e','i','j','f'])